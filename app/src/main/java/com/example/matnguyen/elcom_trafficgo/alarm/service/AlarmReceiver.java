package com.example.matnguyen.elcom_trafficgo.alarm.service;
...
import com.example.matnguyen.elcom_trafficgo.alarm.ui.AlarmLandingPageActivity;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public static void setReminderAlarm(Context context, Alarm alarm) {
        ...
        Log.e(TAG, context.toString() + " - " + alarm.getId());
