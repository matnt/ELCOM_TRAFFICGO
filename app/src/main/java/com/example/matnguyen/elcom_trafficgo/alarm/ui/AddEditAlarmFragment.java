...
import com.example.matnguyen.elcom_trafficgo.alarm.service.AlarmReceiver;
import com.example.matnguyen.elcom_trafficgo.alarm.service.LoadAlarmsService;
import com.example.matnguyen.elcom_trafficgo.alarm.util.ViewUtils;

import java.util.Calendar;

public final class AddEditAlarmFragment extends Fragment {
    private static final String TAG = "ADD EDIT ALARM FRAGMENT";
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.edit_tab_alarm, menu);
    ...
    private void save() {
        ...
        Log.e(TAG, alarm.getTime() + " - " + alarm.getLabel() + " - " );
